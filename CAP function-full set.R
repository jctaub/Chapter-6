#CAP function (previously called PAA)
###################################

#functions to replace NAs with the word 'missing'

remove.na.cat<- function(dataset, key1, key2, key3, key4, key5, key6, target){
  ...
  dataset$Var6<-as.numeric(dataset$Var6)
  ...
  dataset$Var6[is.na(dataset$Var6)]<- 'missing'
  ...
  vars<- c('Var1', 'Var2', 'Var3', 'Var4', 'Var5', 'Var6', 'target')
...
# CAP function key size 6 where non-matches are coded as 0

paa.6.m10<- function(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
  ...
  table3<- merge(dataset, table3, by= c('Var1', 'Var2', 'Var3', 'Var4', 'Var5', 'Var6', 'Var7'))
  table3$origx<- table3$Freq.x
  table3$origy<- table3$Freq.y
  table3$Freq.x<- NULL
  table3$Freq.y<- NULL
  vars<- c('Var1', 'Var2', 'Var3', 'Var4', 'Var5', 'Var6','Var7','origx', 'origy')
  table3<- table3[, vars]
  
  #pop 1
  syn1tab1<-as.data.frame(ftable(syndata1$Var1, syndata1$Var2, syndata1$Var3, 
                                 syndata1$Var4, syndata1$Var5, syndata1$Var6,
                                 syndata1$target))
  ...
  syn2tab1<- as.data.frame(ftable(syndata2$Var1, syndata2$Var2, syndata2$Var3,
                                  syndata2$Var4, syndata2$Var5, syndata2$Var6,
                                  syndata2$target))
  ...
  syn3tab1<- as.data.frame(ftable(syndata3$Var1, syndata3$Var2, syndata3$Var3,
                                  syndata3$Var4, syndata3$Var5, syndata3$Var6,
                                  syndata3$target))
  ...
  syn4tab1<- as.data.frame(ftable(syndata4$Var1, syndata4$Var2, syndata4$Var3,
                                  syndata4$Var4, syndata4$Var5, syndata4$Var6,
                                  syndata4$target))
  ...
  syn5tab1<- as.data.frame(ftable(syndata5$Var1, syndata5$Var2, syndata5$Var3,
                                  syndata5$Var4, syndata5$Var5, syndata5$Var6,
                                  syndata5$target))
  ...
  syn6tab1<- as.data.frame(ftable(syndata6$Var1, syndata6$Var2, syndata6$Var3,
                                  syndata6$Var4, syndata6$Var5, syndata6$Var6,
                                  syndata6$target))
  ...
  syn7tab1<- as.data.frame(ftable(syndata7$Var1, syndata7$Var2, syndata7$Var3,
                                  syndata7$Var4, syndata7$Var5, syndata7$Var6,
                                  syndata7$target))
  ...
  syn8tab1<- as.data.frame(ftable(syndata8$Var1, syndata8$Var2, syndata8$Var3,
                                  syndata8$Var4, syndata8$Var5, syndata8$Var6,
                                  syndata8$target))
  ...
  syn9tab1<- as.data.frame(ftable(syndata9$Var1, syndata9$Var2, syndata9$Var3,
                                  syndata9$Var4, syndata9$Var5, syndata9$Var6,
                                  syndata9$target))
  ...
  syn10tab1<- as.data.frame(ftable(syndata10$Var1, syndata10$Var2, syndata10$Var3,
                                   syndata10$Var4, syndata10$Var5, syndata10$Var6,
                                   syndata10$target))
...
########################################################################################
# CAP function key size 5 where non-matches are coded as 0
...
####################################################################################################
# CAP function key size 4 where non-matches are coded as 0
...
##########################################################################
# CAP function key size 3 where non-matches are coded as 0
...
#function combining the different key sizes- non-matches coded as 0

col.paa.6.m10<- function(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                         syndata8, syndata9, syndata10,key1, key2, key3, key4, key5, key6, target){
  
  set6<-paa.6.m10(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                  syndata8, syndata9, syndata10,key1, key2, key3, key4, key5, key6, target)
  set5<- paa.5.m10(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                   syndata8, syndata9, syndata10,key1, key2, key3, key4, key5, key6, target)
  set4<- paa.4.m10(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                   syndata8, syndata9, syndata10,key1, key2, key3, key4,key5, key6, target)
  set3<- paa.3.m10(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                   syndata8, syndata9, syndata10,key1, key2, key3, key4, key5, key6, target) 
...
col.paa.6.m10(LCF2014, cart_lcf1, cart_lcf2, cart_lcf3, cart_lcf4, cart_lcf5, cart_lcf6, cart_lcf7,
...
# CAP function key size 6 where non-matches are excluded

paa.6.m10.wo0<- function(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                         syndata8, syndata9, syndata10,key1, key2, key3, key4, key5, key6, target){
...
#####################################################################################################
# CAP function key size 5 where non-matches are excluded
...
# CAP function key size 4 where non-matches are excluded
...
###################################################################################################
# CAP function key size 3 where non-matches are excluded
...
#function combining the different key sizes- non-matches are excluded

col.paa.6.m10.wo0<- function(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                             syndata8, syndata9, syndata10,key1, key2, key3, key4, key5, key6, target){
  
  set6<-paa.6.m10.wo0(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                      syndata8, syndata9, syndata10,key1, key2, key3, key4, key5, key6, target)
  set5<- paa.5.m10.wo0(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                       syndata8, syndata9, syndata10,key1, key2, key3, key4, key5, key6, target)
  set4<- paa.4.m10.wo0(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                       syndata8, syndata9, syndata10,key1, key2, key3, key4,key5, key6, target)
  set3<- paa.3.m10.wo0(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                       syndata8, syndata9, syndata10,key1, key2, key3, key4, key5, key6, target) 
  df<-rbind(set6, set5, set4, set3)
  print(df)
}

col.paa.6.m10.wo0(LCF2014, cart_lcf1, cart_lcf2, cart_lcf3, cart_lcf4, cart_lcf5, cart_lcf6, cart_lcf7,
                  cart_lcf8, cart_lcf9, cart_lcf10, 'gor', 'output_area', 'tenure', 'dwelling', 
                  'internet', 'hhsize', 'econ_ref')
