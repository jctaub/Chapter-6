remove.na.cat5<- function(dataset, key1, key2, key3, key4, key5, target){
  ...
  dataset$Var1<-as.numeric(dataset$Var1)
  dataset$Var2<-as.numeric(dataset$Var2)
  dataset$Var3<-as.numeric(dataset$Var3)
  dataset$Var4<-as.numeric(dataset$Var4)
  dataset$Var5<-as.numeric(dataset$Var5)
  dataset$target<-as.numeric(dataset$target)
  
  dataset$Var1[is.na(dataset$Var1)]<- 'missing'
  dataset$Var2[is.na(dataset$Var2)]<- 'missing'
  dataset$Var3[is.na(dataset$Var3)]<- 'missing'
  dataset$Var4[is.na(dataset$Var4)]<- 'missing'
  dataset$Var5[is.na(dataset$Var5)]<- 'missing'
  dataset$target[is.na(dataset$target)]<- 'missing'
  ...
  vars<- c('Var1', 'Var2', 'Var3', 'Var4', 'Var5', 'target')
  dataset<- dataset[, vars]
  
  return(dataset)
}

remove.na.cat4<- function(dataset, key1, key2, key3, key4, target){
  dataset$Var1<- dataset[[key1]]
  dataset$Var2<- dataset[[key2]]
  dataset$Var3<- dataset[[key3]]
  dataset$Var4<- dataset[[key4]]
  ...
  vars<- c('Var1', 'Var2', 'Var3', 'Var4', 'target')
  dataset<- dataset[, vars]
  
  return(dataset)
}

remove.na.cat3<- function(dataset, key1, key2, key3, target){
  dataset$Var1<- dataset[[key1]]
  dataset$Var2<- dataset[[key2]]
  dataset$Var3<- dataset[[key3]]
  dataset$target<- dataset[[target]]
...
# CAP function for key size 5 with non-matches excluded

paa.5.m10.wo0<- function(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                         syndata8, syndata9, syndata10,key1, key2, key3, key4, key5, target){
  
  #Rmove missing
  dataset<- remove.na.cat5(dataset, key1, key2, key3, key4, key5, target)
  syndata1<- remove.na.cat5(syndata1, key1, key2, key3, key4, key5, target)
  syndata2<- remove.na.cat5(syndata2, key1, key2, key3, key4, key5, target)
  syndata3<- remove.na.cat5(syndata3, key1, key2, key3, key4, key5, target)
  syndata4<- remove.na.cat5(syndata4, key1, key2, key3, key4, key5, target)
  syndata5<- remove.na.cat5(syndata5, key1, key2, key3, key4, key5, target)
  syndata6<- remove.na.cat5(syndata6, key1, key2, key3, key4, key5, target)
  syndata7<- remove.na.cat5(syndata7, key1, key2, key3, key4, key5, target)
  syndata8<- remove.na.cat5(syndata8, key1, key2, key3, key4, key5, target)
  syndata9<- remove.na.cat5(syndata9, key1, key2, key3, key4, key5, target)
  syndata10<- remove.na.cat5(syndata10, key1, key2, key3, key4, key5, target)
  
  #orig PAA
  table1<-as.data.frame(ftable(dataset$Var1, dataset$Var2, dataset$Var3, dataset$Var4,
                               dataset$Var5, dataset$target))
  table1<- subset(table1, table1$Freq!=0)
  table2<-as.data.frame(ftable(dataset$Var1, dataset$Var2, dataset$Var3, dataset$Var4, 
                               dataset$Var5))
  
  table3<-merge(table1, table2, by= c('Var1', 'Var2', 'Var3', 'Var4', 'Var5'))
  table3<-subset(table3, table3$Freq.y!=0)
  dataset$Var6<- dataset$target
  table3<- merge(dataset, table3, by= c('Var1', 'Var2', 'Var3', 'Var4', 'Var5', 'Var6'), all.x= TRUE)
  table3$origx<- table3$Freq.x
  table3$origy<- table3$Freq.y
  table3$Freq.x<- NULL
  table3$Freq.y<- NULL
  vars<- c('Var1', 'Var2', 'Var3', 'Var4', 'Var5', 'Var6','origx', 'origy')
  table3<- table3[, vars]
  
  #pop 1
  syn1tab1<-as.data.frame(ftable(syndata1$Var1, syndata1$Var2, syndata1$Var3, 
                                 syndata1$Var4, syndata1$Var5, syndata1$target))
  syn1tab2<-as.data.frame(ftable(syndata1$Var1, syndata1$Var2, syndata1$Var3,
                                 syndata1$Var4, syndata1$Var5))
  ...
  #pop 2
  syn2tab1<- as.data.frame(ftable(syndata2$Var1, syndata2$Var2, syndata2$Var3,
                                  syndata2$Var4, syndata2$Var5, syndata2$target))
  syn2tab2<- as.data.frame(ftable(syndata2$Var1, syndata2$Var2, syndata2$Var3,
                                  syndata2$Var4, syndata2$Var5))
  ...
  #pop 3
  syn3tab1<- as.data.frame(ftable(syndata3$Var1, syndata3$Var2, syndata3$Var3,
                                  syndata3$Var4, syndata3$Var5, syndata3$target))
  syn3tab2<- as.data.frame(ftable(syndata3$Var1, syndata3$Var2, syndata3$Var3,
                                  syndata3$Var4, syndata3$Var5))
  ...
  #pop 4
  syn4tab1<- as.data.frame(ftable(syndata4$Var1, syndata4$Var2, syndata4$Var3,
                                  syndata4$Var4, syndata4$Var5, syndata4$target))
  syn4tab2<- as.data.frame(ftable(syndata4$Var1, syndata4$Var2, syndata4$Var3,
                                  syndata4$Var4, syndata4$Var5))
  ...
  #pop 5
  syn5tab1<- as.data.frame(ftable(syndata5$Var1, syndata5$Var2, syndata5$Var3,
                                  syndata5$Var4, syndata5$Var5, syndata5$target))
  syn5tab2<- as.data.frame(ftable(syndata5$Var1, syndata5$Var2, syndata5$Var3,
                                  syndata5$Var4, syndata5$Var5))
  ...
  #pop 6
  syn6tab1<- as.data.frame(ftable(syndata6$Var1, syndata6$Var2, syndata6$Var3,
                                  syndata6$Var4, syndata6$Var5,syndata6$target))
  syn6tab2<- as.data.frame(ftable(syndata6$Var1, syndata6$Var2, syndata6$Var3,
                                  syndata6$Var4, syndata6$Var5))
  ...
  #pop 7
  syn7tab1<- as.data.frame(ftable(syndata7$Var1, syndata7$Var2, syndata7$Var3,
                                  syndata7$Var4, syndata7$Var5,syndata7$target))
  syn7tab2<- as.data.frame(ftable(syndata7$Var1, syndata7$Var2, syndata7$Var3,
                                  syndata7$Var4, syndata7$Var5))
  ...
  #pop 8
  syn8tab1<- as.data.frame(ftable(syndata8$Var1, syndata8$Var2, syndata8$Var3,
                                  syndata8$Var4, syndata8$Var5, syndata8$target))
  syn8tab2<- as.data.frame(ftable(syndata8$Var1, syndata8$Var2, syndata8$Var3,
                                  syndata8$Var4, syndata8$Var5))
  ...
  #pop 9
  syn9tab1<- as.data.frame(ftable(syndata9$Var1, syndata9$Var2, syndata9$Var3,
                                  syndata9$Var4, syndata9$Var5, syndata9$target))
  syn9tab2<- as.data.frame(ftable(syndata9$Var1, syndata9$Var2, syndata9$Var3,
                                  syndata9$Var4, syndata9$Var5))
  ...
  #pop 10
  syn10tab1<- as.data.frame(ftable(syndata10$Var1, syndata10$Var2, syndata10$Var3,
                                   syndata10$Var4, syndata10$Var5, syndata10$target))
  syn10tab2<- as.data.frame(ftable(syndata10$Var1, syndata10$Var2, syndata10$Var3,
                                   syndata10$Var4, syndata10$Var5))
  ...
  table3$paa_orig<- table3$origx/table3$origy
  ...
  paa= c(mean(combined$paa1), mean(combined2$paa2), mean(combined3$paa3), mean(combined4$paa4),
         ...
         mean(combined9$paa9), mean(combined10$paa10), mean(table3$paa_orig))
...
# CAP function for key size 4 with non-matches excluded


paa.4.m10.wo0<- function(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                         syndata8, syndata9, syndata10,key1, key2, key3, key4,target){
  
  #Rmove missing
  dataset<- remove.na.cat4(dataset, key1, key2, key3, key4, target)
  syndata1<- remove.na.cat4(syndata1, key1, key2, key3, key4, target)
  syndata2<- remove.na.cat4(syndata2, key1, key2, key3, key4, target)
  syndata3<- remove.na.cat4(syndata3, key1, key2, key3, key4, target)
  syndata4<- remove.na.cat4(syndata4, key1, key2, key3, key4, target)
  syndata5<- remove.na.cat4(syndata5, key1, key2, key3, key4, target)
  syndata6<- remove.na.cat4(syndata6, key1, key2, key3, key4, target)
  syndata7<- remove.na.cat4(syndata7, key1, key2, key3, key4, target)
  syndata8<- remove.na.cat4(syndata8, key1, key2, key3, key4, target)
  syndata9<- remove.na.cat4(syndata9, key1, key2, key3, key4, target)
  syndata10<- remove.na.cat4(syndata10, key1, key2, key3, key4, target)
  ...
  table3<-subset(table3, table3$Freq.y!=0)
  dataset$Var5<- dataset$target
  table3<- merge(dataset, table3, by= c('Var1', 'Var2', 'Var3', 'Var4', 'Var5'))
  table3$origx<- table3$Freq.x
  table3$origy<- table3$Freq.y
  table3$Freq.x<- NULL
  table3$Freq.y<- NULL
  vars<- c('Var1', 'Var2', 'Var3', 'Var4', 'Var5', 'origx', 'origy')
  table3<- table3[, vars]
  ...
  #pop 10
  syn10tab1<- as.data.frame(ftable(syndata10$Var1, syndata10$Var2, syndata10$Var3,
                                   syndata10$Var4, syndata10$target))
  syn10tab2<- as.data.frame(ftable(syndata10$Var1, syndata10$Var2, syndata10$Var3,
                                   syndata10$Var4))
...
# CAP function for key size 3 with non-matches excluded


paa.3.m10.wo0<- function(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                         syndata8, syndata9, syndata10,key1, key2, key3, target){
  
  #Rmove missing
  dataset<- remove.na.cat3(dataset, key1, key2, key3, target)
  syndata1<- remove.na.cat3(syndata1, key1, key2, key3, target)
  syndata2<- remove.na.cat3(syndata2, key1, key2, key3, target)
  syndata3<- remove.na.cat3(syndata3, key1, key2, key3, target)
  syndata4<- remove.na.cat3(syndata4, key1, key2, key3, target)
  syndata5<- remove.na.cat3(syndata5, key1, key2, key3, target)
  syndata6<- remove.na.cat3(syndata6, key1, key2, key3, target)
  syndata7<- remove.na.cat3(syndata7, key1, key2, key3, target)
  syndata8<- remove.na.cat3(syndata8, key1, key2, key3, target)
  syndata9<- remove.na.cat3(syndata9, key1, key2, key3, target)
  syndata10<- remove.na.cat3(syndata10, key1, key2, key3, target)
  
  #orig PAA
  table1<-as.data.frame(ftable(dataset$Var1, dataset$Var2, dataset$Var3, dataset$target))
  table1<- subset(table1, table1$Freq!=0)
  table2<-as.data.frame(ftable(dataset$Var1, dataset$Var2, dataset$Var3))
  
  table3<-merge(table1, table2, by= c('Var1', 'Var2', 'Var3'))
  table3<-subset(table3, table3$Freq.y!=0)
  dataset$Var4<- dataset$target
  table3<- merge(dataset, table3, by= c('Var1', 'Var2', 'Var3', 'Var4'), all.x=TRUE)
  table3$origx<- table3$Freq.x
  table3$origy<- table3$Freq.y
  table3$Freq.x<- NULL
  table3$Freq.y<- NULL
  vars<- c('Var1', 'Var2', 'Var3', 'Var4', 'origx', 'origy')
  table3<- table3[, vars]
  ...
  #pop 2
  syn2tab1<- as.data.frame(ftable(syndata2$Var1, syndata2$Var2, syndata2$Var3, syndata2$target))
  syn2tab2<- as.data.frame(ftable(syndata2$Var1, syndata2$Var2, syndata2$Var3))
  ...
  #pop 3
  syn3tab1<- as.data.frame(ftable(syndata3$Var1, syndata3$Var2, syndata3$Var3, syndata3$target))
  syn3tab2<- as.data.frame(ftable(syndata3$Var1, syndata3$Var2, syndata3$Var3))
  ...
  #pop 4
  syn4tab1<- as.data.frame(ftable(syndata4$Var1, syndata4$Var2, syndata4$Var3, syndata4$target))
  syn4tab2<- as.data.frame(ftable(syndata4$Var1, syndata4$Var2, syndata4$Var3))
  ...
  #pop 5
  syn5tab1<- as.data.frame(ftable(syndata5$Var1, syndata5$Var2, syndata5$Var3, syndata5$target))
  syn5tab2<- as.data.frame(ftable(syndata5$Var1, syndata5$Var2, syndata5$Var3))
  ...
  #pop 6
  syn6tab1<- as.data.frame(ftable(syndata6$Var1, syndata6$Var2, syndata6$Var3, syndata6$target))
  syn6tab2<- as.data.frame(ftable(syndata6$Var1, syndata6$Var2, syndata6$Var3))
  ...
  #pop 7
  syn7tab1<- as.data.frame(ftable(syndata7$Var1, syndata7$Var2, syndata7$Var3, syndata7$target))
  syn7tab2<- as.data.frame(ftable(syndata7$Var1, syndata7$Var2, syndata7$Var3))
  ...
  #pop 8
  syn8tab1<- as.data.frame(ftable(syndata8$Var1, syndata8$Var2, syndata8$Var3, syndata8$target))
  syn8tab2<- as.data.frame(ftable(syndata8$Var1, syndata8$Var2, syndata8$Var3))
  ...
  #pop 9
  syn9tab1<- as.data.frame(ftable(syndata9$Var1, syndata9$Var2, syndata9$Var3, syndata9$target))
  syn9tab2<- as.data.frame(ftable(syndata9$Var1, syndata9$Var2, syndata9$Var3))
  ...
  #pop 10
  syn10tab1<- as.data.frame(ftable(syndata10$Var1, syndata10$Var2, syndata10$Var3, syndata10$target))
  syn10tab2<- as.data.frame(ftable(syndata10$Var1, syndata10$Var2, syndata10$Var3))
...
########################################################################################
# CAP function for key size 5 with non-matches as zeros

paa.5.m10<- function(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                     syndata8, syndata9, syndata10, key1, key2, key3, key4, key5, key6, target){
  
  #Rmove missing
  dataset<- remove.na.cat(dataset, key1, key2, key3, key4, key5, key6, target)
  syndata1<- remove.na.cat(syndata1, key1, key2, key3, key4, key5, key6, target)
  syndata2<- remove.na.cat(syndata2, key1, key2, key3, key4, key5, key6, target)
  syndata3<- remove.na.cat(syndata3, key1, key2, key3, key4, key5, key6, target)
  syndata4<- remove.na.cat(syndata4, key1, key2, key3, key4, key5, key6, target)
  syndata5<- remove.na.cat(syndata5, key1, key2, key3, key4, key5, key6, target)
  syndata6<- remove.na.cat(syndata6, key1, key2, key3, key4, key5, key6, target)
  syndata7<- remove.na.cat(syndata7, key1, key2, key3, key4, key5, key6, target)
  syndata8<- remove.na.cat(syndata8, key1, key2, key3, key4, key5, key6, target)
  syndata9<- remove.na.cat(syndata9, key1, key2, key3, key4, key5, key6, target)
  syndata10<- remove.na.cat(syndata10, key1, key2, key3, key4, key5, key6, target)
  ...
  combined10$paa_orig<- combined10$origx/combined10$origy
  ...
  paa= c(mean(combined10$paa1), mean(combined10$paa2), mean(combined10$paa3), mean(combined10$paa4),
         ...
         mean(combined10$paa9), mean(combined10$paa10), mean(combined10$paa_orig))
  df= data.frame(m, key, paa)
  return(df)
}
...
####################################################################################################
# CAP function for key size 4 with non-matches as zeros

paa.4.m10<- function(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                     syndata8, syndata9, syndata10,key1, key2, key3, key4, key5, key6, target){
...
##########################################################################
# CAP function for key size 3 with non-matches as zeros

paa.3.m10<- function(dataset, syndata1, syndata2, syndata3, syndata4, syndata5, syndata6, syndata7,
                     syndata8, syndata9, syndata10,key1, key2, key3, key4, key5, key6, target){
...
#running function for CART LCF data

paa.5.m10.wo0(LCF2014, cart_lcf1, cart_lcf2, cart_lcf3, cart_lcf4, cart_lcf5, cart_lcf6, cart_lcf7,
              cart_lcf8, cart_lcf9, cart_lcf10, 'gor', 'output_area', 'tenure', 'dwelling', 
              'internet', 'econ_ref')

paa.4.m10.wo0(LCF2014, cart_lcf1, cart_lcf2, cart_lcf3, cart_lcf4, cart_lcf5, cart_lcf6, cart_lcf7,
              cart_lcf8, cart_lcf9, cart_lcf10, 'gor', 'output_area', 'tenure', 'dwelling', 
              'econ_ref')

paa.3.m10.wo0(LCF2014, cart_lcf1, cart_lcf2, cart_lcf3, cart_lcf4, cart_lcf5, cart_lcf6, cart_lcf7,
              cart_lcf8, cart_lcf9, cart_lcf10, 'gor', 'output_area', 'tenure', 'econ_ref')


paa.5.m10(LCF2014, cart_lcf1, cart_lcf2, cart_lcf3, cart_lcf4, cart_lcf5, cart_lcf6, cart_lcf7,
                              cart_lcf8, cart_lcf9, cart_lcf10, 'gor', 'output_area', 'tenure', 'dwelling', 
                              'internet', 'hhsize','econ_ref')

paa.4.m10(LCF2014, cart_lcf1, cart_lcf2, cart_lcf3, cart_lcf4, cart_lcf5, cart_lcf6, cart_lcf7,
                 cart_lcf8, cart_lcf9, cart_lcf10, 'gor', 'output_area', 'tenure', 'dwelling', 
                 'internet', 'hhsize', 'econ_ref')


paa.3.m10(LCF2014, cart_lcf1, cart_lcf2, cart_lcf3, cart_lcf4, cart_lcf5, cart_lcf6, cart_lcf7,
          cart_lcf8, cart_lcf9, cart_lcf10, 'gor', 'output_area', 'tenure', 'dwelling', 
          'internet', 'hhsize', 'econ_ref')
